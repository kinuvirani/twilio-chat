...
const GearUpErrorUtils = require('./helpers/gearup-error-utils');
const {ErrorHandler, RuntimeError} = require('./helpers/gearup-error-utils');
...
GearUpErrorUtils.configure(errorHandlerConfig);
